...
import TeamData from "../../data/work/WorkData.json";
...
const TeamOne = () => {
    return (
        ...
        <div className="container">
            ...
            <h2 className="title mb--50">How we work</h2>
            <p>No matter what your requirement is Mobile App and web development, we have a specific approach which comprises of the following</p>
            </div>
            <div className="row">
                {allData.map((data) => (
